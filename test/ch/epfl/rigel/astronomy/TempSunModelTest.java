...
public class TempSunModelTest {
    ...
    void testAt() {
        ...
        assertEquals(SunModel.SUN.at(-2349, new EclipticToEquatorialConversion(ZonedDateTime.of(LocalDate.of(2003, Month.JULY,
                27), LocalTime.of(0, 0, 0, 0), ZoneOffset.UTC))).equatorialPos().raHr(), 8.3926828082978, 1e-14);
        ...
        assertEquals(SunModel.SUN.at(J2010.daysUntil(zdt),
                new EclipticToEquatorialConversion(zdt)).equatorialPos().dec(), 0.3353207024580374);
