 ...
 */
public class LEpochTest {

    @Test
    void daysUntilWorks() {
        assertEquals(ZonedDateTime.now().getDayOfYear() + 10 * 365 + 2 + ZonedDateTime.now().getHour() / 24d,
                Epoch.J2010.daysUntil(ZonedDateTime.now()), 10e-2);
